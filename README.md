...
Step 1: Count k-mers >> count_kmers.sh

- will produce .M.kmers files for males, and .F.kmers files for females.

########################################################################################################

Step 2: Make "FEMALE UNIVERSAL" set of k-mers, which is used as subtraction set. >> female_univ.sh

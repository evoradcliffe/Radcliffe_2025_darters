...
do
    echo "java -Xmx4G -jar ${PICARD} MarkDuplicates \
        TMP_DIR=$TMPDIR \
        INPUT=/home/wrad07/rmoran-lab/projects/darter_WGS/Raw_Reads_2025/25205Mra_N25125/Aligned_Reads/rgadd_out/${s}_rgadd.bam \
        OUTPUT=/home/wrad07/rmoran-lab/projects/darter_WGS/Raw_Reads_2025/25205Mra_N25125/Aligned_Reads/dups_marked/${s}_dupsmarked.bam \
        METRICS_FILE=/home/wrad07/rmoran-lab/projects/darter_WGS/Raw_Reads_2025/25205Mra_N25125/Aligned_Reads/dups_marked/${s}_metrics.txt \
